...
const Price = () => {
  ...
  const handleBtn = async () => {
    try {
      ...
      console.log(resp);
      console.log(resp?.data?.basePrice, "b");
      setData(resp?.data?.basePrice);
      navigate(`/${id}/legal`);
    } catch (err) {
      console.log(err);
    }
      ...
      >
        ...
        <div className="flex flex-col justify-center items-center gap-4">
          <div className="flex flex-col justify-start items-center border border-gray-400 w-full h-[250px] rounded-2xl bg-gray-50">
            ...
            <div className="flex flex-col items-center justify-center w-7/12">
              ...
              <span className="text-md md:text-xl text-center">
                Places like yours in your area usually range from $20 to $34
              </span>
            </div>
          </div>
          ...
          <div className="p-4 flex flex-row justify-between items-start border border-gray-400 w-full h-[150px] rounded-2xl bg-gray-50 focus-within:checked">
            <div>
              <span className="text-sm md:text-lg mb-4 font-semibold">
                Get booked faster
              </span>
              <br />
              <span className="text-md md:text-xl text-gray-600 ">
                Offer 20% off to your first 3 guests to help your place stand
                out.
              </span>
            </div>
