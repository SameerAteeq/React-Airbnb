        ...
        <div className='flex h-full flex-col justify-center items-center relative'>
                ...
                <div className='flex flex-row justify-center items-start flex-wrap gap-4 max-w-[700px]'>
                    {StructureData.map((item) => (
                        <div key={item.id} className="">
                            <div className='px-4 flex flex-col flex-wrap items-start justify-center border-[2px] w-[160px] h-[100px] sm:w-[240px] md:w-[200px] hover:border-[#333] rounded-xl cursor-pointer '>
            ...
            <div className=' fixed bottom-0 right-0 left-0 bg-[#fff] w-full '>
                ...
                <div className='flex flex-row justify-between items-center p-4 '>
                    ...
                    <button onClick={() => navigate("/step1/privacy-type")} className='bg-gray-600 text-white px-8 py-3 rounded-lg '>
                        Next
                    </button>
                </div>
            </div>
