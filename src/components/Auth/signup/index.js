                ...
                <div className='p-2 md:p-4 w-full'>
                    <form className='w-full' >
                        <div className='flex flex-col mb-3 gap-1'>
                            <label className='text-lg font-semibold text-[#333]'>Full Name</label>
                            <input type="text" className='rounded-md bg-gray-100 p-3 ' />
                        </div>
                    ...
                    <div className='flex flex-row items-center gap-2 mt-3'>
                        ...
                        <Link to="/login" className='text-pink-600 font-semibold'>Login</Link>
                    </div>
                </div>
            </div>
        </div>
